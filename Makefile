...
# COMPILER
CC := gcc
CFLAGS := -Wall -Wextra -Iinclude -Iinclude/utility/glfw/glfw-include -std=c23 -std=gnu23 -Wno-unused-parameter -Wno-missing-field-initializers -Wno-sign-compare -c
